...
%.o: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/ccs2020/ccs/tools/compiler/ti-cgt-armllvm_4.0.3.LTS/bin/tiarmclang.exe" -c @"device.opt"  -march=thumbv6m -mcpu=cortex-m0plus -mfloat-abi=soft -mlittle-endian -mthumb -O2 -I"C:/Users/l/workspace_ccstheia/Modular_testing_totalGPIO_NEW_gyro_Replicate_test" -I"C:/Users/l/workspace_ccstheia/Modular_testing_totalGPIO_NEW_gyro_Replicate_test/Debug" -I"C:/ti/mspm0_sdk_2_11_00_07/source/third_party/CMSIS/Core/Include" -I"C:/ti/mspm0_sdk_2_11_00_07/source" -g -Wall -MMD -MP -MF"$(basename $(<F)).d_raw" -MT"$(@)"  $(GEN_OPTS__FLAG) -o"$@" "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

build-184612639: ../empty.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"C:/ti/sysconfig_1.26.2/sysconfig_cli.bat" --script "C:/Users/l/workspace_ccstheia/Modular_testing_totalGPIO_NEW_gyro_Replicate_test/empty.syscfg" -o "." -s "C:/ti/mspm0_sdk_2_11_00_07/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

device_linker.cmd: build-184612639 ../empty.syscfg
device.opt: build-184612639
device.cmd.genlibs: build-184612639
ti_msp_dl_config.c: build-184612639
ti_msp_dl_config.h: build-184612639
Event.dot: build-184612639
