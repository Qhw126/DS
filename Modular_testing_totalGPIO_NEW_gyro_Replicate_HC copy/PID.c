...
/*============================================================================
 * PID 总初始化 — 集中配置所有 PID 参数（对齐参考工程 PID_Iint）
 *===========================================================================*/
void PID_Iint(void)
{
    /*---------- 电机A 增量式 PID（输出单位：PWM） ----------*/
    PID_MotorA.Kp         = 1.32f;
    PID_MotorA.Ki         = 0.112f;
    PID_MotorA.Kd         = 0.0f;
    PID_MotorA.Target_Iint = 70.0f;
    PID_MotorA.Target     = PID_MotorA.Target_Iint;
    PID_MotorA.OutMax     = 400.0f;
    PID_MotorA.OutMin     = -400.0f;
    PID_MotorA.Actual     = 0.0f;
    PID_MotorA.Out        = 0.0f;

    /*---------- 电机B 增量式 PID（输出单位：PWM） ----------*/
    PID_MotorB.Kp         = 1.313f;
    PID_MotorB.Ki         = 0.11f;
    PID_MotorB.Kd         = 0.001f;
    PID_MotorB.Target_Iint = 70.0f;
    PID_MotorB.Target     = PID_MotorB.Target_Iint;
    PID_MotorB.OutMax     = 400.0f;
    PID_MotorB.OutMin     = -400.0f;
    ...
    PID_findway.Kd      = 1.5f;
    PID_findway.Target  = 0.0f;
    PID_findway.Out     = 0.0f;
    PID_findway.OutMax  = 100.0f;
    PID_findway.OutMin  = -100.0f;
    PID_findway.I_MAX   = 200.0f;
    PID_findway.I_MIN   = -200.0f;
