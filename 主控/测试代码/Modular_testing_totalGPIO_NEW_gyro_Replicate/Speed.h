...
/*============================================================================
 * 速度→占空比 转换系数（对齐参考工程 speed_to_dutycycle）
 * 参考工程: 2000 / (12/7.4 × 400) ≈ 3.086
 * 我们:     1000 / (12/7.4 × 400) ≈ 1.543
 * 作用: PID输出(RPM) × 此系数 = CCR写入值
 *===========================================================================*/
#define speed_to_dutycycle      (MOTOR_PWM_PERIOD / (MOTOR_SUPPLY_VOLTAGE / MOTOR_RATED_VOLTAGE * MOTOR_RATED_RPM))
