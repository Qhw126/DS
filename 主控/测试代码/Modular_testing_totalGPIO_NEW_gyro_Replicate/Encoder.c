...
void Encoder_Init(void)
{
    ...
    /* PB21 → TIMG8_CCP0 (PHA), function 3 */
    DL_GPIO_initPeripheralInputFunction(IOMUX_PINCM49, IOMUX_PINCM49_PF_TIMG8_CCP0);
    /* PB22 → TIMG8_CCP1 (PHB), function 3 */
    DL_GPIO_initPeripheralInputFunction(IOMUX_PINCM50, IOMUX_PINCM50_PF_TIMG8_CCP1);
