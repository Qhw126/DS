...
#define OLED_W_SCL(x)   DL_GPIO_writePinsVal(GPIOB, DL_GPIO_PIN_9, (x) ? DL_GPIO_PIN_9 : 0)
#define OLED_W_SDA(x)   DL_GPIO_writePinsVal(GPIOB, DL_GPIO_PIN_8, (x) ? DL_GPIO_PIN_8 : 0)
